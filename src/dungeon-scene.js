...
export default class DungeonScene extends Phaser.Scene {
  ...
  create() {
    ...
    for (const room of this.dungeon.rooms) {
      ...
      this.groundLayer.putTileAt(Tiles.WALL.TOP_LEFT.TOP_HALF, left, top);
      this.groundLayer.putTileAt(Tiles.WALL.TOP_LEFT.BOTTOM_HALF, left, top - 1);
      this.groundLayer.putTileAt(Tiles.WALL.TOP_RIGHT.TOP_HALF, right, top);
      this.groundLayer.putTileAt(Tiles.WALL.TOP_RIGHT.BOTTOM_HALF, right, top - 1);
      this.groundLayer.putTileAt(Tiles.WALL.BOTTOM_RIGHT.TOP_HALF, right, bottom + 1);
      this.groundLayer.putTileAt(Tiles.WALL.BOTTOM_RIGHT.BOTTOM_HALF, right, bottom);
      this.groundLayer.putTileAt(Tiles.WALL.BOTTOM_LEFT.TOP_HALF, left, bottom + 1);
      this.groundLayer.putTileAt(Tiles.WALL.BOTTOM_LEFT.BOTTOM_HALF, left, bottom);
